            ...
            <div className="pt-8 border-t border-zinc-200 dark:border-zinc-800 space-y-4">
              ...
              <div
                className={`p-7 sm:p-9 rounded-3xl border shadow-sm ${
                  isLight
                    ? 'bg-zinc-50/80 border-zinc-200/90 text-zinc-800 shadow-zinc-200/30'
                    : 'bg-zinc-900/80 border-zinc-800 text-zinc-200 backdrop-blur-md'
                }`}
              >
                <FormattedDescription text={course.detailed_description || course.description || ''} />
              </div>
            </div>
          )}
